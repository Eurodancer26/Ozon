...
gulp.task("watch", () => {
  ...
  notify: true
    ...
    gulp.watch("./src/assets/favicon/**/*").on('all', gulp.parallel('favicon'));
    gulp.watch("./src/assets/img/**/*").on('all', gulp.parallel('images'));
    gulp.watch("./src/assets/db/**/*").on('all', gulp.parallel('db'));
});

gulp.task("build", gulp.parallel("copy-html", "build-js", "copy-php", "build-sass", "fonts", "icons", "images", "favicon", "db"));
